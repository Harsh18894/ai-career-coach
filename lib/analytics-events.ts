...
/**
 * Which intake a session came through. The brief asks for sample vs. real-résumé as a segment,
 * and the no-résumé guided path is a third thing that would otherwise be silently lumped in
 * with "own".
 */
 ...
 * hostname — there is no free-text field, because a free-text field is where résumé content
 * eventually ends up.
 */
